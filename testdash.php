            ...
            <div class="flex">
                ...
                <div style="max-width: 20rem;"
                    ...
                    <nav
                        ...
                        <?php if ($_SESSION['user_creation'] || $_SESSION['user_search']) {
                                    ...
                                    <div
                                        ...
                                        <nav
                                            ...
                                            ?>
                                                ...
                                                <a href="./User/userCreationReport.php"
                                                    class="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none text-start hover:bg-blue-gray-50 hover:bg-opacity-80 hover:text-blue-gray-900 focus:bg-blue-gray-50 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-blue-gray-50 active:bg-opacity-80 active:text-blue-gray-900">
                                                    <div class="grid mr-4 place-items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                            stroke-width="3" stroke="currentColor" aria-hidden="true"
                        ...
                        if ($_SESSION['membership_create'] || $_SESSION['membership_search'] || $_SESSION['membership_report']) {
                                ...
                                <div class="overflow-hidden hidden " id="membership-li-area">
                                    <div
                                        ...
                                        <nav
                                            ...
                                            <?php if ($_SESSION['membership_create']) {
                                            ...
                                            <?php if ($_SESSION['membership_search']) {
                                            ...
                                            ?>
                                                ...
                                                <a href="./membership/membershipReport.php"
                                                    class="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none text-start hover:bg-blue-gray-50 hover:bg-opacity-80 hover:text-blue-gray-900 focus:bg-blue-gray-50 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-blue-gray-50 active:bg-opacity-80 active:text-blue-gray-900">
                                                    <div class="grid mr-4 place-items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                            stroke-width="3" stroke="currentColor" aria-hidden="true"
                        ...
                        if ($_SESSION['receipt_creation'] || $_SESSION['receipt_search'] || $_SESSION['receipt_report']) {
                                ...
                                <div class="overflow-hidden hidden " id="memberRecipt-li-area">
                                    <div
                                        ...
                                        <nav
                                            ...
                                            <?php if ($_SESSION['receipt_creation']) {
                                            ...
                                            <?php if ($_SESSION['receipt_report']) {
                        ...
                        if ($_SESSION["fees_search"] || $_SESSION["fess_creation"]) {
