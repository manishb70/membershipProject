...
";
        ...
        if (isset($_POST["search_button"])) {
            ...
            $sql = "SELECT * FROM user_info WHERE id='$search_query' OR user_name='$search_query' ";
...
<body class="">
    ...
    <form action="#" method="POST">
                        <input type="hidden" id="userNumber"  name="userNumber" value=' . $row["id"] . '>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">

                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        ' . ($isEditable ? "<input class='formInputData'  name='id' disabled style='max-width:80px' id=" . $row["id"] . "  margin-left:0' value=" . $row["id"] . ">" : $row["id"]) . '
                    </th>
                    <td class=px-6 py-4">
                    ...
                    <td class="px-6 py-4">
                    ' . ($isEditable ? "<input class='formInputData' name='mobile_number' disabled style='max-width:80px'  margin-left:0' value=" . $row["mobile_no"] . ">" : $row["mobile_no"]) . '
                    </td>
                    <td class="px-6 py-4">
                        ' . ($isEditable ? "<input class='formInputData' name='email_id' disabled style='max-width:80px'  margin-left:0' value=" . $row["emai_id"] . ">" : $row["emai_id"]) . '
                    </td>
                
                    <td class="px-6 py-4">
                        ' . ($isEditable ? "<input  type='date' class='formInputData' name='start_date' disabled style='max-width:80px'  margin-left:0' value=" . $row["effective_from_date"] . ">" : $row["effective_from_date"]) . '
                    </td>
                    <td class="px-6 py-4">
                       
                         ' . ($isEditable ? "<input class='formInputData' name='end_date' disabled style='max-width:80px'  margin-left:0' value=" . $row["effective_from_date"] . ">" : $row["effective_from_date"]) . '
                    </td>
                     <td class="px-6 py-4">
                        
                         ' . ($isEditable ? "<input class='formInputData' name='role' disabled style='max-width:80px'  margin-left:0' value=" . $row["description"] . ">" : $row["description"]) . '
                    </td>
                     <td class="px-6 py-4">
                        
                         ' . ($isEditable ? "<input class='formInputData' name='updataed_by' disabled style='max-width:80px'  margin-left:0' value=" . $row["membership_id"] . ">" : $row["membership_id"]) . '
                    </td>  
